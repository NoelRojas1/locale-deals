...
import RequireLabelIcon from "@/components/RequireLabelIcon";
          ...
          <div className="grid gap-8 grid-cols-1 md:grid-cols-2">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Locale Deals Message <RequireLabelIcon />
                  </FormLabel>
                  <FormControl>
                    <Textarea
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      Background Color <RequireLabelIcon />
                    </FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      Banner Container <RequireLabelIcon />
                    </FormLabel>
                    <FormControl>
                      <Input disabled={!canCustomizeBanner} {...field} />
                    </FormControl>
